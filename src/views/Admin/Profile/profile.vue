    ...
    <section class="mt-40 sm:mx-36" data-aos="fade-up" data-aos-duration="1000">
        <div class="bg-customBGCards rounded-xl shadow-xl p-6 sm:w-full">
            <span class="text-3xl  text-customDarkPurple px-5 py-3 rounded-2xl flex items-center gap-2 m-10"> <i
                    class="fa-duotone fa-sparkles"></i>بيانات المسئول </span>

            <form action="" @submit.prevent="update">
                <div class="grid grid-cols-1 sm:grid-cols-4 gap-10">
                    <div class="flex flex-col">
                        <label for="in1">اسم المسئول</label>
                        <input v-model="name" disabled id="email" type="text" class="item-data" />
                    </div>
                    <div class="flex flex-col">
                        <label for="in1">البريد الالكتروني </label>
                        <input v-model="email" disabled id="email" type="text" class="item-data" />
                    </div>
                    <div class="flex flex-col">
                    ...
                    <div class="flex flex-col">
                        ...
                        <input v-model="job" disabled id="job" type="text" class="item-data" />
                    </div>
                    <div class="flex flex-col input-group">
                        <input id="email" v-model="phone" class="input" required="" autocomplete="off" type="text" />
                        <label for="in5" class="user-label">رقم الهاتف </label>
                    </div>
                    <div class="flex flex-col input-group">
                        <input id="email" v-model="address" class="input" required="" autocomplete="off" type="text" />
        ...
        <div class="bg-customBGCards rounded-xl shadow-xl p-6 mt-10 sm:w-full">
            <span class="text-3xl  text-customDarkPurple px-5 py-3 rounded-2xl flex items-center gap-2 m-10"> <i
                    class="fa-duotone fa-sparkles"></i>بيانات الادارة (للمسئول) </span>
        ...
        <div class="bg-customBGCards rounded-xl shadow-xl p-6 mt-10 sm:w-full">
            <span class="text-3xl  text-customDarkPurple px-5 py-3 rounded-2xl flex items-center gap-2 m-10"> <i
                    class="fa-duotone fa-sparkles"></i>تغيير كلمة المرور </span>

            <form action="" @submit.prevent="updatePassword" class="flex flex-col gap-10">
                <div class="flex flex-col input-group">
                    <input v-model="OldPassword" required="" autocomplete="off" id="Oemail" type="password"
                        class="input" />
                    <label for="email" class="user-label ">
                        كلمة المرور القديمة<span class="text-red-600">*</span></label>
                </div>
                <div class="flex flex-col input-group">
                    <input v-model="NewPassword" required="" autocomplete="off" id="Nemail" type="password"
                        class="input" />
                    <label for="email" class="user-label">
                        كلمة المرور الجديدة<span class="text-red-600">*</span></label>
                </div>
                <div class="flex flex-col input-group">
                    <input v-model="NewPasswordConf" id="password" required="" autocomplete="off" type="password"
                        class="input" />
