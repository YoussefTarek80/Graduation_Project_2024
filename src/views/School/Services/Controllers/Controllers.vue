<template>
    <div>
        ...
        <section class="m-6 sm:m-16" data-aos="fade-up" data-aos-duration="1000">
            ...
            <FilterComponent :filteredArray="filtered_Array" @filter="handleFilter" :MainArray="GetControllers"
                :controller="true" :Search="true"></FilterComponent>
            <table_Component :items="filtered_Array" :infoRoute="'/School/Services/Controllers/ControllerInfo'"
