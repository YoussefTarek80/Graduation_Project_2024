<template>
  ...
  <section class="m-10" data-aos="fade-up" data-aos-duration="1000">
    ...
    <div class="bg-customBGCards rounded-xl shadow-xl p-6 mt-10 sm:w-full mx-auto">
      <div class="my-5"><span class="text-2xl">بيانات المناسبة</span></div>
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div class="flex flex-col">
          <label for="" class="p-2">اسم المناسبة <span class="text-red-600">*</span></label>
          <input disabled v-model="event.name" class="item-data">
        </div>
        <div class="flex flex-col">
          <label for="" class="p-2">تاريخ المناسبة <span class="text-red-600">*</span></label>
          <input disabled v-model="event.date" class="item-data">
        </div>
        <div class="flex flex-col">
          <label for="" class="p-2"> وقت الحدث<span class="text-red-600">*</span></label>
          <input disabled v-model="event.time" class="item-data">
        </div>
        <div class="flex flex-col">
          <label for="" class="p-2">عنو ان الحدث<span class="text-red-600">*</span></label>
          <input disabled v-model="event.address" class="item-data">
        </div>
        <!-- <div class="flex flex-col">
          <label for="" class="p-2">الحالة<span class="text-red-600">*</span></label>
          <input disabled v-model="event.state" class="item-data">
        </div> -->
      </div>
