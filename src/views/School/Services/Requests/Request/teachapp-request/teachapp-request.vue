<template>
    <div>
        ...
        <section class="m-10" data-aos="fade-up" data-aos-duration="1000">
            <BaseTeleport :show="success">
                <div class="flex flex-col">
                    <span class="text-green-700 text-4xl"> تم القبول بنجاح </span>
        ...
        <section class="flex flex-col items-center w-full mt-6" data-aos="fade-up" data-aos-duration="1000">
            <div class="flex flex-col">
                <span class="sm:text-3xl text-2xl font-bold">بيانات طلب التوظيف </span>
    ...
    methods: {
        ...
        async accept() {
            try {
                ...
                await this.AcceptRejectTeachApp({ id: this.request.id, status: form });
                this.fetchData();
                this.success = true;
