        ...
        <div
            ...
            <form action="" class="w-11/12 space-y-4 flex flex-col" @submit.prevent="resetPassword">
                ...
                <div class="flex flex-col">
                    ...
                    <input id="password" v-model="pass" placeholder="كلمة المرور" type="password"
                        class="border-2 border-gray-300 px-5 py-2 rounded-3xl outline-none" @input="Invalid_Data" />
                </div>
                <div class="flex flex-col">
                    <label for="email" class="my-2 mx-2">
                    ...
                    <input id="password" v-model="conf_pass" placeholder="كلمة المرور" type="password"
                        class="border-2 border-gray-300 px-5 py-2 rounded-3xl outline-none" @input="Invalid_Data" />
                </div>
    ...
    methods: {
        ...
        async resetPassword() {
            try {
                ...
                await axios.post("http://127.0.0.1:8000/api/school/reset-password", {
