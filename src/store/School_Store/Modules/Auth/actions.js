...
export const actions = {
            ...
            const studs = [
                {
                    ...
                    schoolname: "السعيدية",
                    address: "مصر - القاهرة",
                    detailedAddress: 'القاهرة - مصر القديمة - النزهة',
                    level: "الصف الثاني الاعدادي",
                    schoolAdminstration: "الجيزة",
                    parentPassion: "مهندس",
                    nationality: "مصري",
                    country: "مصر",
                    nationalId: "3020102272656",
                    state: 'القاهرة',
                },
                {
                    id: 2,
                    ...
                    parent: "طارق صلاح محمد",
                    parentPassion: "دكتور",
                    nationality: "سعودي",
                    country: "السعودية",
                    nationalId: "3020102272651",
                    address: "مصر - الجيزة",
                    state: null,
                    detailedAddress: 'الجيزة -الهرم - سهل حمزة',
                },
                {
                    id: 3,
                    name: 'مجدي خالد كيلاني',
                    schoolname: "مصطفي كامل",
                    schoolAdminstration: "الوراق",
                    email: 'magdi@darb.com',
                    address: 'سهل حمزة',
                    parent: 'خالد كيلاني',
                    parentPassion: 'معلم',
                    nationalId: '3020242241422',
                    level: 'الصف الثاني الإعدادي',
                    nationality: 'مصري',
                    country: 'مصر',
                    detailedAddress: 'كورنيش النيل - الوراق - ش/ جمال عبد الناصر',
                    state: 'الجيزة',
                }
            ];
    ...
    async RemoveController({ commit, dispatch }, id) {
        try {
            ...
            teachers.splice(controllers.indexOf(id), 1);
    ...
    async UpdateTeacher({ commit }, { updateData, id }) {
        try {
            const token = localStorage.getItem("token");
            // await axios.post(
            //     `http://127.0.0.1:8000/api/updateEvent/${id}`,
    ...
    async UpdateController({ commit }, { updateData, id }) {
        try {
            const token = localStorage.getItem("token");
            // await axios.post(
            //     `http://127.0.0.1:8000/api/updateEvent/${id}`,
    ...
    async AddEvent({ dispatch }, eventData) {
        try {
            const token = localStorage.getItem("token");
            // const response = await axios.post(
